...
public interface SaleSheetDao {
    ...
    */
    ...
    /**
     * 通过saleSheetId找到对应的content条目
     * @param saleSheetId
     * @return
     */
    List<SaleSheetContentPO> findContentBySaleSheetId(String saleSheetId);

    SaleSheetPO findOneById(String SheetId);
     ...
     * @return 满足此条件的单据列表
     */
    List<SaleSheetPO> findByFilter(SheetFilterPO sheetFilterPO);
}
