 ...
 *
 */
@MappedTypes(value = {PurchaseSheetState.class, WarehouseInputSheetState.class, WarehouseOutputSheetState.class, CustomerType.class, SaleSheetState.class, PurchaseReturnsSheetState.class,FinancialSheetState.class,SaleReturnsSheetState.class,WarehousePresentSheetState.class,
        PromotionTriggerType.class, PromotionType.class})
